...
# ------ FUNCTIONS -------------------------------------------------------------------------------------
RDMarkovMeans <- function(SFile="SMILES.txt",sResultFile="RDMarkovMeansResults.csv",kPower="3", atomPropExcluded="Zv,EA", atomTypesSelected="Het") {
 ...
 #-------------------------------------------------------------------------------
  ...
  dnew=read.table(SFile,header=F, sep=",")
...
# -----------------------------------------------------------------------------------------------------------------
RDMarkovSingulars <- function(SFile="SMILES.txt",sResultFile="RDMarkovSingularsResults.csv",kPower=3, atomPropExcluded="Zv,EA", atomTypesSelected="Het", fAllKs=0) {
